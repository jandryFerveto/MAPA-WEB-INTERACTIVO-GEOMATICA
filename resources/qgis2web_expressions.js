...
function exp_label_PARCELAS_1_eval_expression(context) {
    // 'Tipo uso de suelo: ' || tipo_uso_de_suelo

    var feature = context.feature;
    
    if (feature.properties) {
        return ('Tipo uso de suelo: ' + feature.get('tipo_uso_de_suelo') );
    } else {
        return ('Tipo uso de suelo: ' + feature.get('tipo_uso_de_suelo') );
    }
}
...
function exp_label_REDVIAL_2_eval_expression(context) {
    // Nombre || ' - ' || Longitud

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('Nombre')  + ' - ') + feature.get('Longitud') );
    } else {
        return ((feature.get('Nombre')  + ' - ') + feature.get('Longitud') );
    }
}
...
function exp_label_AREASDERIESGO_3_eval_expression(context) {
    // 'Nivel de riesgo: ' || Nivel_de_riesgo || '\n' || 'Area: ' || area_m2

    var feature = context.feature;
    
    if (feature.properties) {
        return (((('Nivel de riesgo: ' + feature.get('Nivel_de_riesgo') ) + '\n') + 'Area: ') + feature.get('area_m2') );
    } else {
        return (((('Nivel de riesgo: ' + feature.get('Nivel_de_riesgo') ) + '\n') + 'Area: ') + feature.get('area_m2') );
    }
}
...
function exp_label_REDDEAGUA_4_eval_expression(context) {
    // 'Estado tuberia: ' || "Estado operativo"

    var feature = context.feature;
    
    if (feature.properties) {
        return ('Estado tuberia: ' + feature.get('Estado operativo') );
    } else {
        return ('Estado tuberia: ' + feature.get('Estado operativo') );
    }
}