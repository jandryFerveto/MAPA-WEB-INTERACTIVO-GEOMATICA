...
var format_VIASCONNIVELDERIESGO_2 = new ol.format.GeoJSON();
var features_VIASCONNIVELDERIESGO_2 = format_VIASCONNIVELDERIESGO_2.readFeatures(json_VIASCONNIVELDERIESGO_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VIASCONNIVELDERIESGO_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VIASCONNIVELDERIESGO_2.addFeatures(features_VIASCONNIVELDERIESGO_2);
var lyr_VIASCONNIVELDERIESGO_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VIASCONNIVELDERIESGO_2, 
                style: style_VIASCONNIVELDERIESGO_2,
                popuplayertitle: 'VIAS CON NIVEL DE RIESGO',
                interactive: true,
    title: 'VIAS CON NIVEL DE RIESGO<br />\
    <img src="styles/legend/VIASCONNIVELDERIESGO_2_0.png" /> Alto<br />\
    <img src="styles/legend/VIASCONNIVELDERIESGO_2_1.png" /> Bajo<br />\
    <img src="styles/legend/VIASCONNIVELDERIESGO_2_2.png" /> Medio<br />' });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_PARCELAS_1.setVisible(true);lyr_VIASCONNIVELDERIESGO_2.setVisible(true);lyr_AREASDERIESGO_3.setVisible(true);lyr_REDDEAGUA_4.setVisible(true);lyr_LIMITEZONADEESTUDIO_5.setVisible(true);lyr_PUNTOSZONADEESTUDIO_6.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_PARCELAS_1,lyr_VIASCONNIVELDERIESGO_2,lyr_AREASDERIESGO_3,lyr_REDDEAGUA_4,lyr_LIMITEZONADEESTUDIO_5,lyr_PUNTOSZONADEESTUDIO_6];
lyr_PARCELAS_1.set('fieldAliases', {'fid': 'fid', 'tipo_uso_de_suelo': 'tipo_uso_de_suelo', });
lyr_VIASCONNIVELDERIESGO_2.set('fieldAliases', {'fid': 'fid', 'Nombre': 'Nombre', 'Longitud': 'Longitud', 'Tipo_riesgo': 'Tipo_riesgo', 'Nivel_de_riesgo': 'Nivel_de_riesgo', });
...
lyr_VIASCONNIVELDERIESGO_2.set('fieldImages', {'fid': 'TextEdit', 'Nombre': 'TextEdit', 'Longitud': 'TextEdit', 'Tipo_riesgo': 'TextEdit', 'Nivel_de_riesgo': 'TextEdit', });
...
lyr_VIASCONNIVELDERIESGO_2.set('fieldLabels', {'fid': 'inline label - visible with data', 'Nombre': 'inline label - visible with data', 'Longitud': 'inline label - visible with data', 'Tipo_riesgo': 'inline label - visible with data', 'Nivel_de_riesgo': 'inline label - visible with data', });
